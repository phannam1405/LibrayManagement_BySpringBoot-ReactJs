...
public class AuthenticationService {
    ...
    private String generateToken(User user) {
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .claim("scope", buildScope(user)) //thêm thông tin quyền hạn của user vào token (nằm trong field "scope").
                //.claim("username", user.getUsername()) // có thể custom thêm
                .build();
    ...
    //tổng hợp role và permisson vào scope
